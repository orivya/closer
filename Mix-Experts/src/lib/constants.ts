import { Music2, Sliders, Mic2, Cpu, Speaker, Radio, Layers, LayoutDashboard, FolderOpen, Mail, DollarSign, Settings, ShoppingBag, Calendar, Activity, Bot } from "lucide-react";
...
export const ENGINEER_NAV = [
    ...
    { name: 'Portfolio', href: '/dashboard/portfolio', icon: Music2 },
    { name: 'Calendar', href: '/dashboard/calendar', icon: Calendar },
    { name: 'Analytics', href: '/dashboard/analytics', icon: Activity }, // Added Analytics
    { name: 'Assistant', href: '/dashboard/ai', icon: Bot }, // Added AI Assistant
    { name: 'Services', href: '/dashboard/services', icon: Mic2 },
...
export const CLIENT_NAV = [
    ...
    { name: 'My Orders', href: '/dashboard/client/orders', icon: ShoppingBag },
    { name: 'Downloads', href: '/dashboard/client/downloads', icon: FolderOpen },
    { name: 'Messages', href: '/dashboard/inbox', icon: Mail }, // Reusing inbox
    { name: 'Settings', href: '/dashboard/settings', icon: Settings },
];
