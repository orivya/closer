...
export const FinalCTA: React.FC<FinalCTAProps> = ({ profile }) => {
    // Use profile email or fallback
    const contactEmail = profile?.email || 'contact@mixexperts.com';
    ...
    return (
        <section id="contact" className="py-32 relative overflow-hidden text-center bg-[var(--bg-base)]">
            ...
            <div className="max-w-[1200px] mx-auto px-6 relative z-10">
                ...
                <a href={`mailto:${contactEmail}`} className="inline-block px-10 py-5 bg-white text-[var(--bg-base)] font-bold rounded-full hover:scale-105 transition-all duration-300">
                    Get in Touch
                </a>
            </div>
        </section>
