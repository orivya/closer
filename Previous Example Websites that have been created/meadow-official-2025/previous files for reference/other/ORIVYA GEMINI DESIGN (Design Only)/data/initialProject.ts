// This file contains the snapshot of the current project to allow bootstrapping empty GitHub repos.
...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>ORIVYA — See Yourself Clearly</title>
          ...
          extend: {
            ...
            colors: {
              sage: {
                ...
                light: '#a8c5b5',
                dark: '#546e60',
                glow: 'rgba(125, 155, 138, 0.3)',
                subtle: 'rgba(125, 155, 138, 0.1)',
                muted: 'rgba(125, 155, 138, 0.2)',
              },
              bg: {
                base: '#030304',
                elevated: '#0a0a0c',
            ...
            backgroundImage: {
               'gradient-surface': 'linear-gradient(to bottom right, rgba(255,255,255,0.03), rgba(0,0,0,0))',
            }
          }
        }
      }
    ...
    <style>
      ...
      ::selection {
        background: rgba(125, 155, 138, 0.3);
        color: white;
      }
  ...
  <script type="importmap">
{
  ...
  'metadata.json': `{
  "name": "ORIVYA",
  "description": "See yourself clearly. A private space to think through what matters most.",
...
export default function App() {
  ...
  }, [currentView]); // Re-run observer when view changes
      ...
      <div className="flex h-screen flex-col bg-[#0d1117] text-white">
        <div className="flex items-center justify-between border-b border-[#30363d] bg-[#161b22] px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-sm font-semibold text-white">Orivya Studio</span>
          </div>
    ...
    <div className="relative min-h-screen font-sans text-text-primary overflow-x-hidden selection:bg-sage-muted selection:text-white">
      ...
      >
        ...
        <div className="flex items-center gap-6 opacity-0 animate-[fadeIn_0.8s_ease_1s_forwards]">
          <a href="#" className="hidden text-[13px] font-medium text-text-tertiary transition-colors hover:text-white md:block">Sign in</a>
          <a href="#" className="group relative overflow-hidden rounded-lg bg-sage px-6 py-2.5 text-[13px] font-medium text-white transition-all hover:bg-sage-dark hover:shadow-[0_0_20px_rgba(125,155,138,0.2)]">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-20 text-center">
        ...
        <div className="relative z-10 flex max-w-4xl flex-col items-center pb-20">
          ...
          <div className="flex flex-col items-center gap-4 opacity-0 animate-[fadeIn_1.2s_ease_1.6s_forwards] sm:flex-row">
            <a href="#" className="flex w-full items-center justify-center gap-2 rounded-lg bg-sage px-8 py-3.5 text-sm font-medium text-white transition-all hover:bg-sage-dark hover:shadow-[0_0_30px_rgba(125,155,138,0.25)] hover:-translate-y-0.5 sm:w-auto">
              Start writing
      ...
      <section className="relative px-6 py-32 text-center md:py-48">
        ...
        <div className="relative z-10 mx-auto max-w-2xl reveal-on-scroll">
          ...
          <a href="#" className="inline-block rounded-lg bg-sage px-10 py-4 text-sm font-semibold tracking-wide text-white transition-all hover:bg-sage-dark hover:shadow-[0_0_40px_rgba(125,155,138,0.2)] hover:-translate-y-1">
