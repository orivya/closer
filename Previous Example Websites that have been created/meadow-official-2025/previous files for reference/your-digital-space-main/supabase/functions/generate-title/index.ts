    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "Generate a short title (5 words max) for this conversation. Return only the title, nothing else. No quotes, no punctuation at the end, no explanation."
          },
          {
            role: "user",
